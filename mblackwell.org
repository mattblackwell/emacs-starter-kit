...
#+begin_src emacs-lisp
   ...
   (define-key poly-markdown+R-mode-map (kbd "A-K") 'rmarkdown-render-file)
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "M-'") 'comment-or-uncomment-region)
   ...
   ;; ESS loads tex which messes with the prettify stuff, so unload
   ;; until we need it. 
   ;;(unload-feature 'latex)
   ;;(unload-feature 'tex-ispell)
   ;;(unload-feature 'tex)
...
".rel" ".fls" ".run.xml"))
  ...
  (setq flycheck-lintr-linters "with_defaults(multiple_dots_linter = NULL)")
