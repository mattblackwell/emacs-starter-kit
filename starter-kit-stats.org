...
(setq ess-ask-for-ess-directory nil)
  ...
  (defun my-ess-start-R ()
    (interactive)
    (setq bname (ess-gen-proc-buffer-name:project-or-simple "R"))
    (if (not (member bname (mapcar (function buffer-name) (buffer-list))))
      (progn
  ...
  (add-hook 'ess-mode-hook
	    '(lambda()
	       (local-set-key [A-return] 'ess-eval-region-or-line-and-step)))
